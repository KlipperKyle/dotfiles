...
(global-set-key (kbd "M-<f5>") 'auto-fill-mode)
(global-set-key (kbd "<f6>") 'toggle-truncate-lines)
(global-set-key (kbd "M-<f6>") 'visual-line-mode)
(global-set-key (kbd "<f7>") 'flyspell-buffer)
(global-set-key (kbd "M-<f7>") 'flyspell-mode)
(global-set-key (kbd "<f8>") 'display-line-numbers-mode)
(global-set-key (kbd "M-<f8>") 'indent-tabs-mode)
(global-set-key (kbd "<f9>") 'whitespace-mode)
(global-set-key (kbd "M-<f9>") 'whitespace-report)
