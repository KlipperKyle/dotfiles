...
(global-set-key (kbd "S-<f5>") 'auto-fill-mode)
(global-set-key (kbd "<f6>") 'toggle-truncate-lines)
(global-set-key (kbd "S-<f6>") 'visual-line-mode)
(global-set-key (kbd "<f7>") 'flyspell-buffer)
(global-set-key (kbd "S-<f7>") 'flyspell-mode)
(global-set-key (kbd "<f8>") 'display-line-numbers-mode)
(global-set-key (kbd "S-<f8>") 'indent-tabs-mode)
(global-set-key (kbd "<f9>") 'whitespace-mode)
(global-set-key (kbd "S-<f9>") 'whitespace-report)
(global-set-key (kbd "C-c e") 'eshell)
(global-set-key (kbd "C-c f") 'eww-open-file)
(global-set-key (kbd "C-c g") 'revert-buffer-quick)
